            ...
            <div className="flex gap-0.5">
              {[1, 2, 3, 4, 5].map((star) => (
                <button
                  ...
                  className="cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center p-0.5 rounded-lg focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-white"
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-xs text-brand-primary hover:underline cursor-pointer px-3 py-2.5 min-h-[44px] rounded-lg focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-white"
        >
          Mark all
        </button>
      </div>
