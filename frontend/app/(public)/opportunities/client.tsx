      ...
      <div className="mx-auto max-w-6xl px-4 py-8 md:px-6 lg:py-12">
        ...
        >
          <Button
            ...
            className={`shrink-0 rounded-full py-2.5 min-h-11 font-semibold active:scale-100 ${category !== 'ALL' ? 'bg-brand-surface' : 'hover:bg-brand-primary'}`}
          >
            All
          </Button>
          {ALL_CATEGORIES.map((cat) => (
            <Button
              ...
              className={`shrink-0 rounded-full py-2.5 min-h-11 font-semibold active:scale-100 ${category !== cat ? 'bg-brand-surface' : 'hover:bg-brand-primary'}`}
            >
              {CATEGORY_LABELS[cat]}
            </Button>
          ))}
