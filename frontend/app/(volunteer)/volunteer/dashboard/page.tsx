      ...
      <div className="bg-brand-surface rounded-2xl border border-brand-border overflow-hidden card-hover">
        ...
        <div className="p-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link
            ...
            className="flex items-center justify-between p-4 rounded-xl bg-brand-primary text-brand-bg hover:bg-brand-secondary transition-colors cursor-pointer group active:scale-95 active-bounce touch-select-none focus-visible:ring-2 focus-visible:ring-brand-text focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-brand-bg"
          >
