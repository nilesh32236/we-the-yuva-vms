          ...
          >
            {[1, 2, 3, 4, 5].map((star) => (
              ...
              <button
                ...
                className={`cursor-pointer p-2.5 rounded-lg focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-white ${errors.confidenceLevel ? 'ring-2 ring-brand-error focus-visible:ring-brand-error' : ''}`}
              >
                <Star
