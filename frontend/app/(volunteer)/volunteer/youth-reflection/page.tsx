            ...
            {SKILL_SUGGESTIONS.map((s) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium transition-all focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:outline-none
                    ${
                      isSelected
          ...
          >
            {[1, 2, 3, 4, 5].map((star) => (
              ...
              <button
                ...
                className={`cursor-pointer p-2.5 focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:outline-none${errors.confidenceLevel ? ' rounded-lg ring-2 ring-brand-error' : ' rounded-lg'}`}
              >
                <Star
