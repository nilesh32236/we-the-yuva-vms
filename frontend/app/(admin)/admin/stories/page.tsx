              ...
              >
                ...
                <div className="flex items-center gap-2 pt-1">
                  ...
                  <Button
                    ...
                    className={`
                      flex items-center gap-1.5 text-xs font-medium rounded-xl text-brand-error
                      border-brand-border hover:bg-brand-error/10 hover:border-brand-error/30 py-3 px-3
                    `}
                  >
                    Delete
                  </Button>
