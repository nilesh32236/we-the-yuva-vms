...
export default function CoordinatorProfilePage() {
  ...
  if (isLoading)
    return (
      <div className="flex items-center justify-center h-40 text-brand-muted text-sm" role="status">
        Loading…
      </div>
    );
    ...
    <div className="max-w-2xl space-y-5">
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          >
            <Icon
              className="w-4 h-4 text-cyan-600 dark:text-cyan-400 mx-auto mb-1.5"
              aria-hidden="true"
            />
      ...
      <div className="bg-brand-surface rounded-2xl border border-brand-border p-5">
        ...
        <dl className="space-y-3 text-sm">
          <div className="flex justify-between">
            ...
            <dd className="font-medium text-brand-text">Coordinator</dd>
          </div>
          <div className="flex justify-between">
