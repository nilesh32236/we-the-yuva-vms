                ...
                if (!d) {
                  return (
                    <Button
                      ...
                      className="w-full h-auto p-6 flex flex-col rounded-xl border-2 border-dashed border-brand-border hover:border-brand-primary hover:bg-brand-bg/50 transition-colors text-center cursor-pointer"
                    >
                ...
                return (
                  ...
                  >
                    ...
                    <Button
                      type="button"
                      variant="ghost"
                      className="min-h-[44px] min-w-[44px] flex items-center justify-center p-2 text-xs text-brand-error hover:underline cursor-pointer hover:bg-transparent hover:text-brand-error/80"
                      onClick={() =>
                ...
                if (!d) {
                  return (
                    <Button
                      ...
                      className="w-full h-auto p-4 rounded-xl border-2 border-dashed border-brand-border hover:border-brand-border/80 hover:bg-brand-bg/50 transition-colors text-center cursor-pointer"
                    >
            ...
            <div className="space-y-3 p-4 rounded-xl bg-brand-bg border border-brand-border">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="ghost"
                  onClick={() => setStep(0)}
                  className="text-xs text-brand-primary hover:underline min-h-[44px] min-w-[44px] p-2 flex items-center justify-center hover:bg-transparent"
                >
                  Edit
                </Button>
              </div>
