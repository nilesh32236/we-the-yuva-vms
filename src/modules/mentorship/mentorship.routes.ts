...
import { CreateMentorshipSchema, ReviewMentorshipSchema } from '../../shared/schemas/mentorship.schemas';
import {
...
mentorshipRouter.post('/', requireAuth, requirePermission(Permissions.MENTORSHIP_CREATE), validate(CreateMentorshipSchema), requestMentorshipHandler);
...
mentorshipRouter.patch('/:id', requireAuth, requirePermission(Permissions.MENTORSHIP_MANAGE), validate(ReviewMentorshipSchema), reviewMentorshipRequestHandler);
