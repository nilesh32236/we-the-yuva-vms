...
levelsRouter.post('/:levelId/request', requireAuth, requirePermission(Permissions.LEVEL_REQUEST), createLevelRequestHandler);
...
levelsRouter.patch('/admin/level-requests/:id', requireAuth, requirePermission(Permissions.LEVEL_REVIEW), reviewLevelRequestHandler);
