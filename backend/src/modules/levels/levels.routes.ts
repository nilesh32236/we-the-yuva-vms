...
levelsRouter.get(
  '/users/me/level/progress',
  requireAuth,
  requirePermission(Permissions.LEVEL_VIEW),
  getMyProgressHandler
);
levelsRouter.get(
  '/users/me/level/requests',
  requireAuth,
  requirePermission(Permissions.LEVEL_VIEW),
  getMyLevelRequestsHandler
);
levelsRouter.post(
  '/:levelId/request',
  requireAuth,
  requirePermission(Permissions.LEVEL_REQUEST),
  validate(CreateLevelRequestSchema),
  createLevelRequestHandler
);
levelsRouter.delete(
  '/requests/:id',
...
levelsRouter.patch(
  '/admin/level-requests/:id',
  requireAuth,
  requirePermission(Permissions.LEVEL_REVIEW),
  validate(ReviewLevelRequestSchema),
  reviewLevelRequestHandler
);
