  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
        ...
        <Link
          href="/"
          className="flex items-center gap-2 focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:outline-none"
        >
          ...
          >
            WeThe<span className="text-emerald-600">Yuva</span>
          </span>
        </Link>
        ...
        <div className="hidden items-center gap-4 md:flex">
          ...
          <Link
            href="/register"
            className="rounded-lg bg-emerald-700 px-5 py-2 text-sm font-semibold text-white transition-colors hover:bg-emerald-800 focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:outline-none"
          >
            Get started
          </Link>
        </div>
        ...
        <button
          ...
          className={`md:hidden focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:outline-none ${
            scrolled ? 'text-slate-900 dark:text-white' : 'text-white'
          }`}
        >
          {mobileOpen ? (
        ...
        <div className="border-b border-slate-200 bg-white px-6 pb-4 md:hidden dark:border-slate-700 dark:bg-slate-900">
          ...
          <div className="mt-4 flex flex-col gap-3">
            ...
            <Link
              href="/register"
              onClick={() => setMobileOpen(false)}
              className="rounded-lg bg-emerald-700 px-5 py-2 text-center text-sm font-semibold text-white transition-colors hover:bg-emerald-800 focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:outline-none"
            >
              Get started
            </Link>
          </div>
