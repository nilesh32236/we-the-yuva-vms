...
export function CTA() {
  ...
  return (
    <section className="bg-emerald-700 py-20 sm:py-28 dark:bg-emerald-800">
      <div
        ref={ref}
      ...
      >
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/register"
            className="rounded-xl bg-white px-7 py-3 font-semibold text-emerald-900 transition-colors duration-200 hover:bg-emerald-50"
          >
            Create free account
          </Link>
          <Link
            href="/register"
            className="rounded-xl border border-white/40 px-7 py-3 font-semibold text-white transition-colors duration-200 hover:bg-white/10"
          >
